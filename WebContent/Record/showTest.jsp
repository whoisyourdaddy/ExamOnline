...
<html>
  ...
  <body>
    <div class="title" style="text-align:center;color:#1E5494;font-weight:bold;font-size:16px;">学号：<%=Uid %>&nbsp;&nbsp;&nbsp;&nbsp;姓名：<%=name%>&nbsp;&nbsp;&nbsp;&nbsp;科目：<%=course%></div>
   ...
   <table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" 
    ...
    <tr>
      <td class="td_bg" colspan="2">
         得分：<input type="text" value="<%=tq.getScore()%>" name="jd<%=i%>" style="font-size:12px;color:#1E5494;" onblur="judgeJd(this)" readonly="readonly" />
   ...
   <table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" 
    ...
    <tr>
      <td class="td_bg" colspan="2">
         得分：<input type="text" value="<%=tq.getScore()%>" name="pro<%=i%>" style="font-size:12px;color:#1E5494;" onblur="judgePro(this)" readonly="readonly" />
