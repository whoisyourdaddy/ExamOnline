...
public class UpdateQuesServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String course = new String(request.getParameter(ch_course).getBytes("iso8859-1"),"utf-8").trim();
		int type = Integer.parseInt(request.getParameter("type").trim());
		String ques = new String(request.getParameter("ques").getBytes("iso8859-1"),"utf-8").trim();
		String keyA = null;
		String keyB = null;
		String keyC = null;
		String keyD = null;
